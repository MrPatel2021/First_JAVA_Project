        ...
        <div class="jobint">
          <div class="row">
            ...
            <form action="<%=application.getContextPath()%>/worker_reg_controller" method="post">
               			<button type="submit" name="action" value="getcategorybyuserid" style="background-color: white;border:none;height: 50px;width: 200px;font-weight: bold;font-size: 25px">
