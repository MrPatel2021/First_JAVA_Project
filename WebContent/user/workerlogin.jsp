  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 col-sm-6"> 
        <h1 class="page-heading">Worker Login</h1>
      </div>
      <div class="col-md-6 col-sm-6">
        </div>
    </div>
...
<div class="listpgWraper">
  <div class="container">
    <div class="row">
      ...
      <form  action="<%=application.getContextPath()%>/WorkerLoginController" data-parsley-validate="true" method="post">
        <div class="userccount">
          ...
          <!-- sign up form -->
          <div class="newuser"><i class="fa fa-user" aria-hidden="true"></i> New Worker?</div>
          <a href="worker.jsp" style="color:#666666;height:30px;width:200px;">Register Here</a>
          <a href="forgotpassword_worker.jsp" style="color:#666666;height:30px;width:200px;">Forget Password</a>
          <!-- sign up form end--> 
