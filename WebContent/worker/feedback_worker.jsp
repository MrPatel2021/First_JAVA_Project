...
<html lang="en">
<%
	worker_reg_bean wb = worker_reg_dao.getWorkerById((Integer) session.getAttribute("id"));
%>
      ...
      <div class="tab-content">
            <div id="candidate" class="formpanel tab-pane fade in active">
              ...
              <h5>Full Name :</h5>
                ...
                <input type="text" name="name" id="name" autofocus class="form-control" placeholder="Name" required data-parsley-length="[3,20]" value=<%= wb.getfname()%>><br>
              </div>
	  </div>
      ...
      <div class="tab-content">
            <div id="candidate" class="formpanel tab-pane fade in active">
              ...
              <h5>Email :</h5>
                ...
                <input type="email" name="email" id="email" autofocus class="form-control" placeholder="Name" required value=<%= wb.getemail()%> data-parsley-error-message="Please Enter Valid E-mail" data-parsley-pattern="^[a-z0-9@.]+$"><br>					
