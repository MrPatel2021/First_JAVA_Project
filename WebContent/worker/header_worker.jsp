...
<%
	worker_reg_bean ub = worker_reg_dao.getuserdatabyid((Integer) session.getAttribute("id"));
%>
<!-- Header start -->
<div class="header">
  <div class="container">
    <div class="row">
      <div class="col-md-2 col-sm-3 col-xs-12"> <a href="index_worker.jsp" class="logo"><img src="resources/images/logo.jpg" alt="" height="80px" width="180px"/></a>
        ...
        <div class="navbar navbar-default" role="navigation">
          <div class="navbar-collapse collapse" id="nav-main">
            <ul class="nav navbar-nav">
              <li class=""><a href="index_worker.jsp">Home </a> </li>
              <li><a href="aboutus_worker.jsp">About Us</a></li>
              <li><a href="contactus_worker.jsp">Contact Us</a></li>
              <li><a href="gallery_worker.jsp">Gallery </a></li> 
                ...
                <ul class="dropdown-menu">
                 <%          	
                  ...
                  <form action="<%=application.getContextPath()%>/worker_reg_controller" method="post">
               			<button type="submit" name="action" value="getcategorybyworkerid" style="background-color: white;border:none;height: 30px;width: 150px;font-weight: bold;">
             ...
             <%--      <li><a href=""><%out.println(acb.getCategoryname());%></a></li> --%>         
                 ...
                 <li><a href="feedback_worker.jsp">Feedback </a></li>                
                 <li> <a href=""  class="font-weight-bold" style="color: blue !important;"><%out.println(ub.getfname());%></a>                 
                  <ul class="dropdown-menu">
                    <li><a href="worker_profile.jsp"><i class="fa fa-pencil" aria-hidden="true"></i> Profile Of Worker</a></li>
                     <li role="separator" class="divider"></li>
                    <li><a href="logout_worker.jsp"><i class="fa fa-sign-out" aria-hidden="true"></i> Logout</a></li>
                </ul>
                 </li>       
