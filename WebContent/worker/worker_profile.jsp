	...
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<%=application.getContextPath()%>/EditProfileWorkerController" data-parsley-validate="true">
					<div class="row">
						...
						<div class="col-sm-12 col-md-6 col-lg-6">
							...
							<%
							 String pwd1 = wb.getpassword();
							 String pwd2 =wb.getconpassword();									
							%>
								<div class="adminpwd">
								...
								<div class="systempwd" style="display:none;">	
									<div class="form-group">
										...
										<%
										 String pwd3 = wb.getpassword();
										 String pwd4 =wb.getconpassword();									
										%>
...
<div id="edit_photo" class="modal fade" role="dialog" style="margin-top:150px;">
	<div class="modal-dialog modal-md">
		<!-- Modal content-->
		<div class="modal-content">
			<form method="post" action="<%=application.getContextPath()%>/EditProfileWorkerController" data-parsley-validate="true" enctype="multipart/form-data">
			...
			<div class="modal-body">
		           <label class ="font-weight-bold">Photo<span style="color:red;">*</span></label><br>
					<input type="file" name="photo" id="photo" required data-parsley-min-file-size="50" data-parsley-max-file-size="250" value="<%=wb.getprofile()  %>"><br>
		     </div>	
			 <div class="modal-footer">
		        <input type="hidden" name="worker_id" value="<%=wb.getwid()%>">
...
<%--         <form action="<%=application.getContextPath()%>/user_reg_controller" method="post"> --%>
          ...
          <ul class="blogList">
            ...
            <li>
              ...
              <div class="row">
                <div class="col-md-5"> 
                  <div class=""><img src="../uploaded_images/<%=wb.getprofile() %>" alt="Blog Title" width="200px" height="200px">               
                  </div>
                </div>                
                <div class="col-md-7">               
                  <div class="post-header">
                    ...
                    <h3><%= wb.getfname()%>
                    <%= wb.getlname()%></h3>
                    <h6><div class="postmeta">Mobile No. : <%= wb.getphone()%></div>
                    <div class="postmeta">Email : <%= wb.getemail()%></div>
                    <span>Address : <%= wb.getaddress()%> </a></div></span></h6>                    
                 </div>                  
                  <span><div class="mt-button-text mt-style-button41"> <a href="editprofile_worker.jsp?id="<%= wb.getwid()%>" class="mt-style-button normal">Edit Profile</a> </div></span>
